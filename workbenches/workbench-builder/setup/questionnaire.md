# Onboarding Questionnaire: Workbench Builder
...
### Q1: What domain is this workbench for?
- Examples: "podcast production", "blog writing", "course creation", "design system management"
- Type: free text
- Purpose: Names the workbench and sets the scope
...
### Q3: Who will use this workbench, and what is their skill level with AI tools?
- Type: free text
