...
This workbench guides you through building a new ICM workbench for any domain -- from understanding the workflow through generating a complete, validated workbench scaffold.

## Stage Count

The number of stages varies by workbench. During Stage 01-discovery, the appropriate stage count is determined based on transformation complexity and human handoff points.
...
└── references/
    ...
    └── examples/
        └── script-to-animation-summary.md  (completed workbench example)
```
...
| Keyword | Action |
|---------|--------|
| `setup` | Run onboarding -- asks about the domain you want to build a workbench for |
...
```
Pipeline Status: workbench-builder
...
| Task | Go To |
|------|-------|
| Start building a new workbench | `stages/01-discovery/CONTEXT.md` |
| Formalize stage contracts | `stages/02-mapping/CONTEXT.md` |
| Generate the workbench files | `stages/03-scaffolding/CONTEXT.md` |
| Design the onboarding questionnaire | `stages/04-questionnaire-design/CONTEXT.md` |
| Validate the workbench | `stages/05-validation/CONTEXT.md` |
...
| Design questionnaire | `stages/01-discovery/output/`, scaffolded workbench from stage 03, `/_core/templates/questionnaire-template.md` | `stages/02-mapping/`, `references/examples/` |
| Validate workbench | Scaffolded workbench from stage 03, `stages/04-questionnaire-design/output/`, `/_core/CONVENTIONS.md` | `stages/01-discovery/`, `stages/02-mapping/`, `references/examples/` |
