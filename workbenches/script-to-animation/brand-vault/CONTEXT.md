...
Brand identity and voice rules for this workbench. Agents load specific sections as directed by stage CONTEXT.md files.

## Files

| File | Key Sections | Load When |
|------|-------------|-----------|
| `voice-rules.md` | "Voice Rules", "What the Voice Is NOT" | Writing any content (scripts, captions, narration) |
